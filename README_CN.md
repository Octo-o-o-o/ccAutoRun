...
ccAutoRun v0.1.0 将 Claude Code 从交互式助手升级为全自动任务执行器。通过 AI 生成智能执行计划,然后让系统自动分阶段执行——你可以专注于更重要的工作。
...
- **文档**: [docs/](docs/)
- **问题反馈**: [GitHub Issues](https://github.com/Octo-o-o-o/ccAutoRun/issues)
- **讨论**: [GitHub Discussions](https://github.com/Octo-o-o-o/ccAutoRun/discussions)
